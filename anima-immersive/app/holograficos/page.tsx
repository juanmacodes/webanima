...
// evita SSG agresivo por el canvas
    ...
    return (
        <main className="pt-32">
            <SharedSection
                ...
                cta={
                    <>
                        <a className="button-primary" href="/world">Tour holográfico</a>
                        <a className="button-ghost" href="/proyectos">Proyectos holográficos</a>
                    </>
                }
            >
                <div className="card">
                    <p className="text-sm text-foreground/70">
                        Configura hologramas bi-direccionales, triggers de contenido y sincronización con plataformas de e-commerce.
                    </p>
            ...
            <Script id="holograficos-service-jsonld" type="application/ld+json"
