...
class RsAddOnParticleWaveBase {
	...
	protected function loadClasses() {
		...
		new SrParticleWaveFront(static::$_PluginTitle);
	...
	public function enqueue_admin_scripts($hook) {
		...
		if($hook === 'toplevel_page_revslider') {
			...
			$_jsPathMin = file_exists(RS_PARTICLEWAVE_PLUGIN_PATH . 'sr6/assets/js/revolution.addon.' . static::$_PluginTitle . '.js') ? '' : '.min';	
	...
	public static function get_var() {
		...
		return array(
			...
			'bricks' => array(		
				...
				// INTERACTION
				'moduleBased' => __('Module Based', $_textdomain),
