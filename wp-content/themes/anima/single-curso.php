<?php
/**
 * Plantilla individual para el CPT Cursos.
 *
 * @package Anima
 */
...
$meta_source = static function ( string $field, string $fallback_key ) {
    ...
    <article <?php post_class( 'single-curso' ); ?>>
        <section class="course-hero container">
            ...
            <div class="hero-content">
                ...
                <?php
                $meta_items = [
                    'precio'    => __( 'Precio', 'anima' ),
                    'duracion'  => __( 'Duración', 'anima' ),
                    'nivel'     => __( 'Nivel', 'anima' ),
                    'modalidad' => __( 'Modalidad', 'anima' ),
                ];
        ...
        <section class="course-body container">
            <h2><?php esc_html_e( 'Descripción', 'anima' ); ?></h2>
            <div class="prose">
                <?php the_content(); ?>
            </div>
            ...
            <?php foreach ( $detail_sections as $slug => $value ) :
                ...
                $titles = [
                    'temario'    => __( 'Temario', 'anima' ),
                    'requisitos' => __( 'Requisitos', 'anima' ),
                    'instructor' => __( 'Instructor', 'anima' ),
                ];
                ?>
